---
title: Using Outlines for LLM Constrained Generation
date: 2025-10-01
tags: ["LLM"]
---
...
[outlines](https://github.com/dottxt-ai/outlines) is not particularly new,
...
Putting this together, we can attempt to get the LLM to play chess (albeit not
very well). It does make me wonder how we may use LLMs to play games in a
precise manner, e.g. if moves are injected in context to 'promote' them or
dissuade an LLM from playing bad moves.
