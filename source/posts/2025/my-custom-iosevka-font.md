...
I've started using my own custom
[Iosevka font](https://github.com/NoRaincheck/Iosevka-Curly). Many of the
...
- the inclusion of `old-style` numerals, where numerals have varying height.
  This helps distinguish between numbers and letters much easier
- changing the default width. This relaxes the 'look' slightly
- adding tails, and/or curvature to the appropriate letters. This is more a
  preference item to distinguish and provide the characters a 'softer' look
